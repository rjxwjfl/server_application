...
CREATE TABLE `task_user` (
  ...
  `task_id` int NOT NULL,
  `user_id` int NOT NULL,
  `task_user_att_id` int DEFAULT NULL,
  `task_pnt` text,
  `task_cmt` text,
...
INSERT INTO `task_user` VALUES (1,8,7,NULL,'A파트 검사 필',NULL,0,'2023-04-27 07:42:35','2023-04-27 07:42:35','2023-04-27 02:30:00','2023-04-27 08:30:00',NULL),(2,8,8,NULL,'B파트 재고파악',NULL,0,'2023-04-27 07:42:35','2023-04-27 07:42:35','2023-04-27 02:30:00','2023-04-27 06:30:00',NULL),(4,9,7,NULL,'A파트 검사 필',NULL,0,'2023-04-27 07:44:39','2023-04-27 07:44:39','2023-04-27 02:30:00','2023-04-27 08:30:00',NULL),(5,9,8,NULL,'B파트 재고파악',NULL,0,'2023-04-27 07:44:39','2023-04-27 07:44:39','2023-04-27 02:30:00','2023-04-27 06:30:00',NULL),(7,10,7,NULL,'A파트 검사 필',NULL,0,'2023-04-27 08:25:52','2023-04-27 08:25:52','2023-04-27 02:30:00','2023-04-27 08:30:00',NULL),(8,10,8,NULL,'B파트 재고파악',NULL,0,'2023-04-27 08:25:52','2023-04-27 08:25:52','2023-04-27 02:30:00','2023-04-27 06:30:00',NULL);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `task_user_AFTER_UPDATE` AFTER UPDATE ON `task_user` FOR EACH ROW BEGIN
    IF NEW.task_state = 1 AND NEW.cmpl_date IS NULL THEN
        UPDATE `task_user` SET cmpl_date = CURRENT_TIMESTAMP WHERE task_user_id = NEW.task_user_id;
    END IF;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
-- Dump completed on 2023-04-27 17:50:21
